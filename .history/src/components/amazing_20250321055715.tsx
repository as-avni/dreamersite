    ...
    <section className="py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="bg-[#6100FF] text-white py-12 px-4 text-center rounded-sm">
          ...
          >
            If you are
            <Image src="./images/small-star.png" alt="star" width={16} height={16} className="absolute top-[-10px] right-[-10px]" />
            <Image src="/images/small-star.png" alt="star" width={16} height={16} className="absolute bottom-[-10px] left-[-10px]" />
          </motion.button>
