...
return (
    <section className=" py-16 px-4 md:px-0 lg:px-0 max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 md:grid-cols-100 items-center">
            {/* Quote Text Section */}
            <motion.div
                className="col-span-54 flex flex-col justify-center"
            ...
            {/* Bill Gates Image */}
            <motion.div
                className="col-span-20 flex justify-center items-center"
            ...
            {/* Green Box Section */}
            <motion.div
                className="h-[280px] col-span-28 bg-[#2E7D32] flex flex-col p-6 text-white rounded-sm relative"
                initial={{ opacity: 0, x: 20 }}
                whileInView={{ opacity: 1, x: 0 }}
        ...
        {/* Orange Section */}
        <motion.div
            className="mt-6 bg-[#FF5722] py-10 px-4 flex items-center justify-center relative overflow-hidden"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
