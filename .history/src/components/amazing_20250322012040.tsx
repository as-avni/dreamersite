          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-2/3">
              <p className="text-xl md:text-3xl font-bold text-black text-left">
                Younicorn Comm<WordColor><span className="[text-shadow:-1px_-1px_0_white,1px_-1px_0_white,-1px_1px_0_white,1px_1px_0_white]">you</span></WordColor>nity is a platform where diversity of folks come
