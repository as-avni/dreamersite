    ...
    <section className=" py-16 px-4 md:px-0 lg:px-0 max-w-7xl mx-auto w-full">
        ...
        >
            <div className="flex items-center justify-center">
                <h2 className="text-4xl md:text-5xl font-black tracking-tight font-serif leading-none">VERY SERI</h2>
                <Image
                ...
                />
                <h2 className="text-4xl md:text-5xl font-black tracking-tight font-serif leading-none">USLY!</h2>
            </div>
