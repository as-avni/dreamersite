                  ...
                  <div className="mt-6 space-y-4">
                    <div className="group relative mb-6">
                      ...
                      <textarea
                        ...
                        rows={4}
                        className="w-full p-2 border hover:border- text-black border-gray-300 rounded focus:ring-2 focus:ring-[#2E7D32] focus:border-transparent outline-none transition-all bg-transparent focus:bg-white"
                        required
                      />
                    </div>
