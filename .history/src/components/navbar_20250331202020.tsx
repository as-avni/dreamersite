  ...
  return (
    <header className="w-full py-4 px-6 flex items-center fixed justify-between top-[1%] z-50 bg-white bg-opacity-100 backdrop-blur-md rounded-full">
      ...
      <div
        ...
        } absolute md:static top-16 left-0 w-full md:w-auto bg-white bg-opacity-[50%] md:bg-transparent shadow-md md:shadow-none rounded-lg md:rounded-none p-4 md:p-0`}
      >
