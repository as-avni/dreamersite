      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-[#6100FF] text-white py-12 px-4 text-center rounded-sm">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <CategoryCard image="https://drive.google.com/file/d/1GyIFfqCe0l2MAVGd6j7eLJKW5Qyf3UPO/view?usp=sharing" title="AN ENTREPRENEUR" />
            <CategoryCard image="https://drive.google.com/uc?id=1iAN--X9l-1xt_8qeUFuS3OzLPTdlCqjY" title="A COLLEGE STUDENT" />
            <CategoryCard image="https://drive.google.com/uc?id=1-v3_0zQLwEmL8N2MSWofmHfHdw3aFjbY" title="A LEADER" />
            <CategoryCard image="https://drive.google.com/uc?id=1fminT3is5BcYf4McTnqsQi8Oz5mVb5Th" title="A DREAMER" />
  ...
  return (
    <motion.div className="flex flex-col items-center" variants={itemVariants}>
      <div className="w-64 h-48 flex items-center justify-center shadow-md border-2 border-white">
        <Image src={getDriveDirectLink(image)} alt={title} width={250} height={250} unoptimized className="object-cover" />
      </div>
