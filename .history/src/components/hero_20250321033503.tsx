  ...
  return (
    <section className="relative flex flex-col items-center justify-center py-20 px-4 bg-[#5D3FD3] text-white text-center overflow-hidden bg-[url('/images/hero-bg.png')] bg-stretch">
      ...
      <div className="relative max-w-3xl mx-auto w-full">
        ...
        <motion.div
          className="inline-flex items-center bg-white rounded-full px-2 py-1 bg-white text-black font-medium transition-all hover:bg-gray-50 shadow-[4px_4px_0px_black]"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
