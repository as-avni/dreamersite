      ...
      <div className="container mx-auto md:px-4">
        ...
        >
          <div className="flex flex-row px-4 mx-auto space-x-12 max-w-7xl">
            <h2 className="text-4xl md:text-7xl font-bold mb-6 tracking-tight" style={{ fontFamily: 'Newsreader, serif', color: 'black' }}>
              WE ARE
            </h2>
            <p className="text-sm md:text-2xl max-w-4xl mddd"leading-[0.92] text-justify font-bold" style={{ fontFamily: 'Newsreader, serif', color: 'black' }}>
