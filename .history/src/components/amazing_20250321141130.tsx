          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-2/3">
              <p className="text-3xl font-bold text-black text-left">
                Younicorn Comm<span className="text-green-600 [text-shadow:-1px_-1px_0_white,1px_-1px_0_white,-1px_1px_0_black,1px_1px_0_black]">you</span>nity is a platform where diversity of folks come
