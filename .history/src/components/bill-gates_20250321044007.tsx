    ...
    <section className=" py-16 px-4 md:px-0 lg:px-0 max-w-6xl mx-auto w-full">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            ...
            <motion.div
                ...
                viewport={{ once: true }}
            >
                <h2 className="px-0 text-xl font-bold mb-4 text-black font-newsreader">Bill Gates once said</h2>
            ...
            <motion.div
                ...
                viewport={{ once: true }}
            >
                <div className="relative w-[200px] h-[300px] bg-gray-200 rounded overflow-hidden">
                    <Image
                        src="/images/bill.jpg"
                        width={200}
                        height={200}
            ...
            {/* Green Box Section */}
            <motion.div
                className="h-[300px] col-span-1 bg-[#2E7D32] flex flex-col justify-center items-center p-6 text-white rounded-sm"
                initial={{ opacity: 0, x: 20 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.6, delay: 0.4 }}
                viewport={{ once: true }}
            >
                <p className="text-4xl font-serif font-bold my-14">And we took</p>
                <p className="text-4xl font-bold font-serif -my-14">it seriously!</p>
            </motion.div>
        </div>
