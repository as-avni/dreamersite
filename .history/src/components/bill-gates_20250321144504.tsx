    ...
    <section className=" py-16 px-4 md:px-0 lg:px-0 max-w-7xl mx-auto w-full">
        ...
        >
            <div className="flex items-center justify-center">
                <h2 className="text-3xl md:text-7xl font-black tracking-tight font-serif text-black">VERY SERI</h2>
                <Image
                    src="/images/seriously.png"
                    width={80}
                    height={80}
                    alt="Serious Photo"
                    className="object-cover hfull w-full"
                />
                <h2 className="text-3xl md:text-7xl font-black tracking-tight font-serif text-black">USLY!</h2>
            </div>
