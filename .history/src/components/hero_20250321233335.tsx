...
export default function Hero() {
  return (
    <section className="relative flex flex-col items-center justify-center py-20 px-4 text-white text-center overflow-hidden bg-[url('/images/grid-bg.png')] bg-stretch h-sc">
      
      {/* Rotating Star Image */}
      <motion.img 
        src="/images/Star.png" 
        alt="Star" 
        className="absolute w-14 md:w-20 h-14 md:h-20 top-[4%] md:top-[10%] left-[10%]"
        animate={{ rotate: 360 }}
