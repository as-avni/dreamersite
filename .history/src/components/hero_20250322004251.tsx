  ...
  return (
    <section className="relative flex flex-col items-center justify-center py-20 px-4 text-white text-center overflow-hidden bg-[url('/images/grid-bg.png')] bg-stretch h-screen">
      ...
      <motion.img 
        src="/images/Star.png" 
        alt="Star" 
        className="absolute w-28 md:w-60 h-28 md:h-60 top-[6%] md:top-[10%] left-[10%]"
        animate={{ rotate: 360 }}
      ...
      <div 
        className="absolute md:w-80 md:h-80 w-24 h-24 bg-cover bg-center top-[1%] md:top-[20%] right-[1%] md:right-[10%]"
