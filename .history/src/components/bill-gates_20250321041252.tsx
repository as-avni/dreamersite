...
return (
    <section className="w-full py-16 px-4 md:px-8 lg:px-16 max-w-6xl mx-auto w-full">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            ...
            <motion.div
                ...
                viewport={{ once: true }}
            >
                <p className="text-4xl text-center font-serif">And we took</p>
                <p className="text-4xl font-bold text-center font-serif">it seriously!</p>
            </motion.div>
        </div>
