    ...
    <section className="py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="bg-[#6100FF] text-white py-12 px-4 text-center rounded-sm">
          ...
          <motion.div
          className="mt-6 bg-[#FFD700] p-4 rounded-sm border-8 border-white"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/3 mb-4 md:mb-0">
              <h3 className="font-bold text-3xl text-black text-left font-newsreader leading-[0.7]">WE ARE FOR</h3>
              <p className="italic text-xl font-bold text-black text-left">The leaders of tomorrow.</p>
            </div>
            <div className="md:w-2/3">
              <p className="italic text-xl font-bold text-black text-left">
                Younicorn Comm<span className="text-green-600">you</span>nity is a platform where diversity of folks come
...
function CategoryCard({ image, title }: { image: string; title: string }) {
  ...
  return (
    <motion.div className="flex flex-col items-center" variants={itemVariants}>
      <div className="w-64 h-40 flex items-center justify-center shadow-md border-2 border-white">
