...
return (
    <section className=" py-16 px-4 md:px-0 lg:px-0 max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2 items-center">
            ...
            {/* Green Box Section */}
            <motion.div
                className="h-[280px] w-[200px] md:w-[340px] col-span-1 mx-auto bg-[#2E7D32] flex flex-col p-6 text-white rounded-sm relative"
                initial={{ opacity: 0, x: 20 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.6, delay: 0.4 }}
                viewport={{ once: true }}>
                <p className="absolute bottom-12 left-4 text-2xl md:text-4xl font-serif font-bold">
                    And we took
                </p>
                <p className="absolute bottom-2 leftmd:left-4 text-2xl md:text-4xl font-bold font-serif">
                    it seriously!
                </p>
            </motion.div>
        ...
        >
            <div className="flex items-center justify-center">
                <h2 className="text-4xl md:text-7xl font-black tracking-tight font-serif text-black">VERY SERI</h2>
                <Image
                ...
                />
                <h2 className="text-4xl md:text-7xl font-black tracking-tight font-serif text-black">USLY!</h2>
            </div>
