...
export default function Hero() {
  return (
    <section className="relative flex flex-col items-center justify-center py-20 px-4 text-white text-center overflow-hidden bg-[url('/images/grid-bg.png')] bg-stretch">
      ...
      <div 
        className="absolute w-60 h-60 bg-cover bg-center"
        style={{ top: "20%", right: "10%", backgroundImage: "url('/images/image.png')" }}
      ></div>

      <div className="relative max-w-3xl mx-auto w-full">
        <motion.h1
          className="text-5xl md:text-6xl lg:text-7xl font-newsreaderfont-bold mb-4 tracking-tight"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
        >
          A Comm<span className="text-[#1F8D42]">you</span>nity of <br />
          <span className="font-rampartone text-[#FF8C5A]">Dreamers</span>
        </motion.h1>
