...
>
  ...
  <h2 className="text-7xl font-bold mb-6 max-w-4xl tracking-tight" style={{ fontFamily: 'Newsreader, serif', color: 'black' }}>
    WE ARE
  </h2>
  <p className="text-2xl max-w-4xl leading-tight text-justify font-bold" style={{ fontFamily: 'Newsreader, serif', color: 'black' }}>
