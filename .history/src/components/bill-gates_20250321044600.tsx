...
return (
    ...
    viewport={{ once: true }}
>
    <p className="absolute bottom-4 left-4 text-4xl font-serif font-bold">
        And we took
    </p>
    <p className="absolute bottom-0 left-4 text-4xl font-bold font-serif">
        it seriously!
    </p>
</motion.div>
        ...
        <motion.div
            ...
            viewport={{ once: true }}
        >
            <h2 className="text-4xl md:text-5xl font-black text-center tracking-tight font-serif">VERY SERI 
                <span>
                <div className="ml-4">
                <svg width="60" height="60" viewBox="0 0 60 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
