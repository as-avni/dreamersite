        ...
        <div className="bg-[#6100FF] text-white py-12 px-4 text-center rounded-sm">
          ...
          >
            ...
            <div className="bg-[#FFCA28] py-2 px-4 text-center w-64 h-full text-black font-medium hover:bg-[#FFB300] transition-colors cursor-pointer">
                <h1 className="font-bold text-xl">Join us to create great opportunities.</h1>
                <p className="text-lg">Let’s make the world a better place.</p>
                <p className="font-bold text-2xl">APPLY TO JOIN <span style="color: black;">↗</span></p>
              </div>
            </motion.div>
          </motion.div>
          <motion.div
