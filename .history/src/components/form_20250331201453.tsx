...
export default function QuickFormSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/form/submit', {
        ...
        body: JSON.stringify({ formData, workProfile }),
      });
  ...
  return (
    <section id=className="py-16 px-10 bg-gray-50 font-newsreader">
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 shadow-xl rounded-sm overflow-hidden">
          ...
          >
            ...
            {formStep === 0 ? (
              <form onSubmit={handleSubmit} className="mt-8 relative overflow-hidden transition-all">
                ...
                <div className="flex justify-center mt-8">
                  <motion.button
                    type="submit"
                    className="bg-[#37743a] text-white px-6 py-2"
            ...
            <motion.div
              className="mt-8  bg-[#FFCA28] p-4 text-center border-gray-500 border-2"
