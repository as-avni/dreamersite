...
return (
    <section className=" py-16 px-4 md:px-0 lg:px-0 max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 md:grid-cols- items-center">
            {/* Quote Text Section */}
            <motion.div
        ...
        {/* Orange Section */}
        <motion.div
            className="mt-10 bg-[#FF5722] py-10 px-4 flex items-center justify-center relative overflow-hidden"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
