      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-[#6100FF] text-white py-12 px-4 text-center rounded-sm">
          ...
          >
            ...
            <motion.div className="flex flex-col items-center h-60" variants={itemVariants}>
              <div className="bg-[#FFCA28] py-2 px-4 text-center w-64 h-48 text-black font-medium hover:bg-[#FFB300] transition-colors cursor-pointer">
