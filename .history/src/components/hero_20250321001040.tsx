...
export default function Hero() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center py-20 px-4 bg-[#5D3FD3] text-white text-center overflow-hidden bg-[url('/images/grid.png')] bg-cover">
