  ...
  return (
    <section className="relative flex flex-col items-center justify-center py-20 px-4 text-white text-center overflow-hidden bg-[url('/images/11.png')] bg-stretch h-screen">
      ...
      <div className="relative max-w-3xl mx-auto w-full">
        ...
        >
            <button className="bg-white flex flex-row text-black rounded-full px-6 py-4 text-sm md:text-xl font-medium transition-all hover:bg-gray-50">
            <TypewriterEffect words={word} />
          <span className="text-black bg-[#FFD54F] p-2 rounded-full font-bold">2 mins</span>
            </button>
        </motion.div>
      </div>
    </section>
