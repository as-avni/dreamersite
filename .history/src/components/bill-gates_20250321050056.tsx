...
return (
    <section className=" py-16 px-4 md:px-0 lg:px-0 max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 md:grid-cols-3 items-center">
            ...
            {/* Green Box Section */}
            <motion.div
                className="h-[280px] w-[340px] col-span-1 bg-[#2E7D32] flex flex-col p-6 text-white rounded-sm relative"
                initial={{ opacity: 0, x: 20 }}
                whileInView={{ opacity: 1, x: 0 }}
        ...
        {/* Orange Section */}
        <motion.div
            className="mt-16 bg-[#FF5722] py-10 px-4 flex items-center justify-center relative overflow-hidden"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
...
<div className="flex items-center justify-center">
    <h2 className="text-4xl md:text-5xl font-black tracking-tight font-serif inline-block leading-none">VERY SERI</h2>
    <Image
        src="/images/seriously.png"
        width={80}
        height={100}
    ...
    />
    <h2 className="text-4xl md:text-5xl font-black tracking-tight font-serif inline-block leading-none">USLY!</h2>
</div>
