...
export default function QuickFormSection() {
  ...
  const handleExpressYourselfChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
    ...
    if (e.target.value.trim() !== "" && formStep === 2) {
      // Activate the checkbox without changing the form step
      document.getElementById("expressYourselfCheckbox")?.setAttribute("data-active", "true");
    }
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 shadow-xl rounded-sm overflow-hidden">
          ...
          >
            ...
            >
              ...
              <CheckItem text="Express Yourself" active={formStep >= 3} id="expressYourselfCheckbox" />
