    ...
    <section className="py-16">
      <div className="container mx-auto md:px-4">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <div className="flex flex-col md:flex-row px-4 mx-auto space-x-12 max-w-7xl">
            <h2 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight" style={{ fontFamily: 'Newsreader, serif', color: 'black' }}>
              WE ARE
            </h2>
            <p className="text-sm md:text-2xl max-w-4xl md:leading-[0.92] text-justify font-bold" style={{ fontFamily: 'Newsreader, serif', color: 'black' }}>
