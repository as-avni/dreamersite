                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  <div className="group relative">
                    ...
                    <input
                      ...
                      className="w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-[#2E7D32] focus:border-transparent outline-none hover:border-black transition-all bg-transparent focus:bg-white"
                      required
                    />
                  </div>
