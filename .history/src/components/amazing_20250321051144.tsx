...
export default function AmazingSection() {
  ...
  viewport={{ once: true }}
>
  <div className="flex flex-row px-4 mx-auto">
  <h2 className="text-6xl font-bold mb-6 tracking-tight" style={{ fontFamily: 'Newsreader, serif', color: 'black' }}>
    WE ARE
  </h2>
  <p className="text-lg max-w-3xl leading-relaxed" style={{ fontFamily: 'Newsreader, serif', color: 'black' }}>
    A community of entrepreneurs, aspiring entrepreneurs, leaders and professionals from any industry who come
    together to gain and give massive exposure to the leaders of tomorrow.
  </p>
  </div>
</motion.div>


        <div className="bg-[#5D3FD3] text-white py-12 px-4 text-center rounded-sm">
          <motion.h2
          ...
          <motion.button
            className="bg-[#4CAF50] text-white px-6 py-2 rounded-full mb-12 shadow-md hover:bg-[#3d9c40] transition-all"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
