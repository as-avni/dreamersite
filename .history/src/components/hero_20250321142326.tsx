  ...
  return (
    <section className="relative flex flex-col items-center justify-center py-20 px-4 text-white text-center overflow-hidden bg-[url('/images/grid-bg.png')] bg-stretch">
      ...
      <motion.img 
        src="/images/Star.png" 
        alt="Star" 
        className="absolute w-20 h-20 top-[4%] md:top-[10%] left-[10%]"
        animate={{ rotate: 360 }}
      ...
      <div 
        className="absolute md:w-60 md:h-60 w-32 h-32 bg-cover bg-center top-[1%] md:top-[20%] right-[1%] md:right-[10%]"
        style={{backgroundImage: "url('/images/image.png')" }}
      ></div>

      <div className="relative max-w-3xl mx-auto w-full">
        <motion.h1
          className="text-3xl md:text-6xl lg:text-7xl font-newsreader font-bold mb-4 tracking-tight"
