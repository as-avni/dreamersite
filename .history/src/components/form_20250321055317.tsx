            ...
            {formStep === 0 ? (
              <form onSubmit={handleSubmit} className="mt-8 relative overflow-hidden transition-all">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  <div className="group relative">
                    ...
                    <input
                      ...
                      className="w-full p-2 border text-black border-gray-300 rounded focus:ring-2 focus:ring-[#2E7D32] focus:border-transparent outline-none hover:border-black transition-all bg-transparent focus:bg-white"
                      required
                    />
                  </div>
                  ...
                  <div className="group relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className=" hover:border-black w-full p-2 border text-b border-gray-300 rounded focus:ring-2 focus:ring-[#2E7D32] focus:border-transparent outline-none transition-all bg-transparent focus:bg-white "
                      required
                    />
                  </div>
                  ...
                  <div className="group relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-[#2E7D32] hover:border-black focus:border-transparent outline-none transition-all bg-transparent focus:bg-white"
                      required
                    />
                  </div>
                </div>
                ...
                <div className="flex justify-end mt-8">
                  <motion.button
                    type="submit"
                    className="bg-[#6cd071] text-white px-6 py-2 rounded shadow-md"
                  ...
                  <div className="mt-6 space-y-4">
                    <div className="group relative mb-6">
                      ...
                      <textarea
                        ...
                        rows={4}
                        className="w-full p-2 border text-black border-gray-300 rounded focus:ring-2 focus:ring-[#2E7D32] focus:border-transparent outline-none transition-all bg-transparent focus:bg-white"
                        required
                      />
                    </div>
                    ...
                    <div className="flex justify-end mt-6">
                      <motion.button
                        type="submit"
                        className="bg-[#0e3b10] text-white px-6 py-2 rounded shadow-md"
                        whileHover={{ scale: 1.05, backgroundColor: "#1B5E20" }}
                        whileTap={{ scale: 0.95 }}
