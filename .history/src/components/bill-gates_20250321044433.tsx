...
return (
    <section className=" py-16 px-4 md:px-0 lg:px-0 max-w-6xl mx-auto w-full">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            ...
            {/* Green Box Section */}
            <motion.div
                className="h-[280px] col-span-1 bg-[#2E7D32] flex flex-col bottom-0 p-6 text-white rounded-sm"
                initial={{ opacity: 0, x: 20 }}
                whileInView={{ opacity: 1, x: 0 }}
        ...
        <motion.div
            ...
            viewport={{ once: true }}
        >
            <h2 className="text-4xl md:text-5xl font-black text-center tracking-tight font-serif">VERY SERIpanUSLY!</h2>
            <div className="ml-4">
