...
export default function AmazingSection() {
  ...
  viewport={{ once: true }}
>
  <div className="flex flex-row px-4 space-x-12 max-w-7xl">
  <h2 className="text-7xl font-bold mb-6 tracking-tight" style={{ fontFamily: 'Newsreader, serif', color: 'black' }}>
    WE ARE
  </h2>
  <p className="text-2xl max-w-3xl leading-tight text-justify font-bold" style={{ fontFamily: 'Newsreader, serif', color: 'black' }}>
