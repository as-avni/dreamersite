...
return (
    <section className="py-16 px-4 md:px-8 lg:px-16 max-w-6xl mx-auto">
        ...
        <motion.div
            ...
            viewport={{ once: true }}
        >
            <h2 className="text-4xl font-bold mb-4 text-black font-newsreader">Bill Gates once said</h2>
            <p className="text-2xl leading-relaxed fon text-black font-newsreader">
