      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 shadow-xl rounded-sm overflow-hidden">
          ...
          >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  ...
                  <div className="group relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="hover:border-black w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-[#2E7D32] focus:border-transparent outline-none transition-all bg-transparent focus:bg-white te\"
                      required
                    />
                  </div>
            ...
            >
              <Link href="/valid-route" className="font-bold text-lg inline-block">
