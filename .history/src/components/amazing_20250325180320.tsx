      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-[#6100FF] text-white py-12 px-4 text-center rounded-sm">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <CategoryCard image="https://drive.google.com/uc?id=1kYRRfkY0zEYjJgRs7fmpQPDLXrOhLeVR" title="AN ENTREPRENEUR" />
            <CategoryCard image="https://drive.google.com/uc?id=YOUR_FILE_ID_2" title="A COLLEGE STUDENT" />
            <CategoryCard image="https://drive.google.com/uc?id=YOUR_FILE_ID_3" title="A LEADER" />
            <CategoryCard image="https://drive.google.com/uc?id=YOUR_FILE_ID_4" title="A DREAMER" />
