...
return (
    <div className="min-h-screen bg-[#5C3FFF] bg-[linear-gradient(#a3a098_1px,transparent_1px),linear-gradient(90deg,#a3a098_1px,transparent_1px)] bg-[size:80px_80px] flex flex-col items-center px-4 py-8">
