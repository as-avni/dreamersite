...
return (
    <div className="min-h-screen bg-white bg-[linear-gradient(#f0f0f0_1px,transparent_1px),linear-gradient(90deg,#f0f0f0_1px,transparent_1px)] bg-[size:0px_0px] flex flex-col items-center px-4 py-8">
    

    {/* Events Heading */}    <h1 className="text-5xl font-bold mt-40">EVENTS</h1>
