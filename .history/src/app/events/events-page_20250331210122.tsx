...
return (
    <div className="min-h-screen bg-[#5C3FFF] bg-[linear-gradient(#f0f0f0_1px,transparent_1px),linear-gradient(90deg,#f0f0f0_1px,transparent_1px)] bg-[size:80px_80px] flex flex-col items-center px-4 py-8">
    

    {/* Events Heading */}   
    <h1 className="text-7xl mt-10 font-dmSerif">EVENTS</h1>
