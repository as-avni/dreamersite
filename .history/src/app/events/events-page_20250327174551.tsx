...
return (
    ...
    <div className="text-center mb-4">
        <h2 className="text-3xl font-bold font-archivenarrow tracking-normal text-[#545454] tracking-tight">{currentEvent.title}</h2>
        <p className="text-xl text-[#545454] font-semibold mb-2">Workshop by - {currentEvent.presenter}</p>
