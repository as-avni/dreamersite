...
<div className="min-h-screen bg-white bg-[linear-gradient(#f0f0f0_1px,transparent_1px),linear-gradient(90deg,#f0f0f0_1px,transparent_1px)] bg-[size:20px_20px] flex flex-col items-center px-4 py-8">
    ...
    <Link href="#" className="bg-[#6c3ce9] text-white px-6 py-2 rounded-full font-semibold">
        Younicorn.club
    </Link>
    <button className="border-2 border-black rounded-full px-6 py-2 font-semibold hover:bg-gray-100 transition-colors">
        GET IN TOUCH
    </button>
    </div>
