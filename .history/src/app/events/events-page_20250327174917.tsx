...
return (
    ...
    {/* Events Heading */}8    
    <h1 className="text-5xl font-bold mt-20 font-dmSerif">EVENTS</h1>
    ...
    <div className="text-center mb-4">
        ...
        <button className="bg-yellow-400 text-black px-6 py-2 rounded-full font-bold flex items-center mx-auto hover:bg-yellow-500 transition-colors border border-black">
            <div className="bg-black rounded-full p-2 border border-black mr-2 flex items-center justify-center">
