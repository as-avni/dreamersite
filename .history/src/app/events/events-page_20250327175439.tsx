...
return (
    ...
    <div className="text-center mb-4">
        ...
        <button className="bg-yellow-400 text-black px-2 py-2 rounded-full font-bold flex items-center mx-auto hover:bg-yellow-500 transition-colors">
        <div className=" mr-2 rounded-full">
            <ChevronRightCircle className="h-6 w-10" />
        </div>
        <span>BOOK NOW</span>
        </button>
    </div>
