...
return (
    ...
    <div className="text-center mb-4">
        <h2 className="text-4xl font-bold font-archivenarrow text-[#545454] tracking-normal">{currentEvent.title}</h2>
        <p className="text-xl font-archivenarrow text-[#545454] font-semibold mb-2">Workshop by - {currentEvent.presenter}</p>
