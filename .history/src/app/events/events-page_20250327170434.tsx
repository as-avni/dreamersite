...
return (
    <div className="min-h-screen bg-red-100 bg-[linear-gradient(#f0f0f0_1px,transparent_1px),linear-gradient(90deg,#f0f0f0_1px,transparent_1px)] bg-[size:20px_20px] flex flex-col items-center px-4 py-8">
